...
import indrora.neural.R;
import indrora.neural.RenderScriptScene;
import indrora.neural.ScriptC_nexus;
import indrora.neural.ScriptField_color_s.Item;
...
class NexusRS extends RenderScriptScene implements OnSharedPreferenceChangeListener {
    ...
    private indrora.neural.ScriptField_color_s.Item makeColor(float r, float g, float b, float a)
    {
      Item i = new Item();
      i.red = r;
      i.blue = b;
    ...
    private void updateColors() {
      android.util.Log.d("NexusRS", "color scheme = "+mSettings.getSchemeName());
      String[] colors_strings = mSettings.getSchemeValues(mSettings.getSchemeName()).split(":");
      Item[] colors = new Item[4];

      for(int idx = 0; idx < colors.length; idx++)
      {
        
        int c = Color.parseColor(colors_strings[idx]);
